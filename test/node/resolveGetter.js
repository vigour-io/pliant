...
var resolveGetter = require('../../lib/bin').resolveGetter
var cases =
    ...
    { str: '-s, --surgeon, --plastic-surgeon', getter: 'surgeon' }
    ]

describe('resolveGetter', function () {
  it('should should give the same answers as provided in the sample data'
  , function () {
